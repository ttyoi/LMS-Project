...
public interface SHomeworkDAO {
    ...
    List<Map<String, Object>> getSubmittedHomework(String loginId);
    List<SHomeworkVO> selectSubmittedHomework(String loginId);
    SHomeworkVO getSubmittedOne(int submissionCode);
    List<SHomeworkVO> submittedList(String loginId);
