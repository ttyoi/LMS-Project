package kr.happyjob.study.domain.login.model;
...
public class LgnInfoModel {
	...
	private String chk_tem_password;
	...
	*/
	...
	public String getChk_tem_password() {
		return chk_tem_password;
	}

	public void setChk_tem_password(String chk_tem_password) {
	...
	public String toString() {
		return "LgnInfoModel{" +
				...
				", status='" + status + '\'' +
				", chk_tem_password='" + chk_tem_password + '\'' +
				", lgn_id='" + lgn_id + '\'' +
				", pwd='" + pwd + '\'' +
				'}';
	}
