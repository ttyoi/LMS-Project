            ...
            <div class="login-form-left-side">
                <fieldset>
                    ...
                    <a class="btn_login" href="javascript:fLoginProc();"
                       id="btn_login"><strong>Login</strong></a>
                    <br>
                        <a href="/join" id="RegisterBtn"><strong>[회원가입]</strong></a>
                        <a href="/searchidApw" id="findIDAPW"><strong>[아이디/비밀번호 찾기]</strong></a>
                </fieldset>
            </div>
