		...
		function init() {
			...
			vueprop2 = new Vue({
								                ...
								                components:{
								                    'my-component-child':{
								                        props:['msg','msg2'],
								                        template : '<div>지역 컴포넌트 {{ msg }} {{ msg2 }}</div>'
								                    },
				...
				<li class="contents">
					...
					<div class="content" style="margin-bottom:20px;">
                        ...
                        <div id="vuevar">
								...
								<div class="fixed-table-body">
										<table width="100%" class="col" border=0>
											...
											<tbody>
											     ...
											     <tr>
											         <td>
												         문자 : <input type="text" class="inputTxt p100"	name="inputtext" id="inputtext" v-model="aa.aaa"  @input="inputkey"   />
												     </td>
												     <td>
												          {{ aa.aaa }}
												     </td>
					        ...
					        <div id = "vueprop2">
					            <my-component-child msg = "파라미터 전송 2222"  msg2 = "우리나라 만세" ></my-component-child>
					        </div>
					        <br>
							<div id="vueprop">
							        <p class="conTitle" style="margin-bottom: 1%;">
