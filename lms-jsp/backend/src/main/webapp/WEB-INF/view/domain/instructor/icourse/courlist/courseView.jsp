...
<link rel="stylesheet" href="/css/course/ckj-inst-course.css" type="text/css" />
				...
				<li class="contents">
					<div class="content">
						<jsp:include page="/WEB-INF/view/common/header.jsp">
							...
							<jsp:param name="refreshUrl" value="${CTX_PATH}/inst/course-list" />
						</jsp:include>
							...
							<div class="ckj-left">
								<div class="ckj-action-section">
									<div class="ckj-inst-tab">
										...
										<button class="ckj-btn ckj-tab-btn active">강의 상세</button>
										...
										<tbody>
											<tr>
												...
												<td colspan="3"><input type="text" id="course-title"
													placeholder="강의명를 선택해주세요." required />
												</td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><select id="class-id">
														<option value="">-- 강의실 선택 --</option>
												</select></td>
												<th class="required">차시</th>
												<td><select id="time-code">
														<option value="">-- 차시 선택 --</option>
												</select></td>
											</tr>
											<tr>
												<th>강사</th>
												<td><input type="text" value="<%=userNm%>" readonly /></td>
												<th>보조강사</th>
							...
							<div class="ckj-right">
								<div class="ckj-action-section">
									<div class="ckj-action">
										<button class="ckj-btn primary disabled" id="save-btn">저장</button>
										<button class="ckj-btn warning" id="delete-btn">삭제</button>
										<button class="ckj-btn" id="cancel-btn">취소</button>
									</div>
								</div>
								<!-- .ckj-action-section -->
								<%
						...
						int sundayOffset = -(dayOfWeek - 1); // 일요일(1)이면 0, 월요일(2)이면 -1 ...
								...
								<div class="ckj-content">
									<div class="ckj-timeline-container">
										<div class="ckj-timeline-nav">
											<p class="ckj-info"><%=yyyy%>년 <%=mm%>월 <%=week%>주차</p>
											<div class="ckj-action">
												<button class="ckj-btn ckj-nav-btn last-week" aria-label="이전 주">이전주</button>
												<button class="ckj-btn" id="timeline-today-btn">오늘</button>
												<button class="ckj-btn ckj-nav-btn next-week" aria-label="다음 주">다음주</button>
												<button class="ckj-btn ckj-img-btn calendar" aria-label="날짜 선택">날짜선택</button>
												<input type="date" id="timeline-date-input" class="ckj-date-trigger" aria-label="날짜 직접 선택">
											</div>
										</div>
...
<!--
<div class="container ckj-container">
	<div class="ckj-top">top</div>
	<div class="ckj-left">left</div>
	<div class="ckj-right">right</div>
</div>
 -->
