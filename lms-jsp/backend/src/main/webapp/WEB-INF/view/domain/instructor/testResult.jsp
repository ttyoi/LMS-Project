                        ...
                        <div>
                            ...
                            <div class="container">
                                ...
                                <div style="text-align: center; margin-top: 14px">
                                    <button class="btn" onclick="location.href='/inst/exams'">
                                        목록으로
                                    </button>
                                </div>
                            </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const studentNameContainer = document.querySelector(".studentName");

        // 현재 URL 예: /inst/exams/detail/1/1/studentId
        const path = window.location.pathname.split("/");

        // 현재 요청 URL localhost/inst/exams/result/1/1/studentId
        const courseId = path[4];
        const period = path[5];
        const studentId = path[6];


        // 백엔드 요청
        fetch(`/inst/exams/result/${courseId}/${period}/${studentId}`)
            .then(res => res.json())
            .then(data => {
                ...
                // 메타 정보
                studentNameContainer.innerHTML = ``
                    +studentName+
                    `님 시험 결과 상세보기
                `;
